...
/***/ "./node_modules/react-chatbot-kit/src/assets/icons/user-alt.svg":
/*!**********************************************************************!*\
  !*** ./node_modules/react-chatbot-kit/src/assets/icons/user-alt.svg ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var SvgUserAlt = function SvgUserAlt(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("svg", _extends({
    ...
    d: "M256 288c79.5 0 144-64.5 144-144S335.5 0 256 0 112 64.5 112 144s64.5 144 144 144m128 32h-55.1c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16H128C57.3 320 0 377.3 0 448v16c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48v-16c0-70.7-57.3-128-128-128"
  })));
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("data:image/svg+xml;base64,");
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"title":"AI Chat Embed","name":"simple-ai-chat-embed/chat-embed","version":"0.1.0","category":"widgets","icon":"format-chat","description":"Embeds an AI-powered chat interface (ChatGPT, Claude, Gemini).","keywords":["chat","ai","chatbot","gpt","claude","gemini"],"supports":{"html":false},"attributes":{"selectedModel":{"type":"string","default":""},"initialPrompt":{"type":"string","default":""},"instanceId":{"type":"string"},"chatbotName":{"type":"string","default":""}},"textdomain":"simple-ai-chat-embed","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./index.css","render":"file:./render.php"}');
...
const modelOptions = [{
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Select a Model', 'simple-ai-chat-embed'),
  value: ''
}, {
  label: 'ChatGPT 4.0',
  value: 'gpt-4o-mini'
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('AI Model Settings', 'simple-ai-chat-embed'),
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Select AI Model', 'simple-ai-chat-embed'),
          value: selectedModel,
          ...
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Initial System Prompt', 'simple-ai-chat-embed'),
          help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Optional text prepended to every user prompt to guide the AI.', 'simple-ai-chat-embed'),
          value: initialPrompt,
          ...
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Chatbot Name', 'simple-ai-chat-embed'),
          help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Optional name for this specific chat instance. Leave blank to use the default.', 'simple-ai-chat-embed'),
          value: chatbotName,
...
function save({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("noscript", {
      children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please enable JavaScript to use the AI Chat.', 'simple-ai-chat-embed')
    })
  });
}
...
class ActionProvider {
  ...
  getAppropriateInstance = currentState => {
    ...
    if (Object.keys(instances).length === 0) {
      ...
      const errorMessage = this.createChatBotMessage(__("I'm unable to process your request at this time. Please try again later.", 'simple-ai-chat-embed'));
  ...
  handleApiResponse = result => {
    ...
    if (result.success && result.data.message) {
      ...
      const botError = this.createChatBotMessage(__('Sorry, I encountered a problem processing your request. Please try again later.', 'simple-ai-chat-embed'));
  ...
  handleApiError = error => {
    ...
    const botError = this.createChatBotMessage(__('Sorry, I was unable to connect to the AI service. Please try again later.', 'simple-ai-chat-embed'));
    this.addMessageToState(botError);
  };
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var react_chatbot_kit_src_assets_icons_user_alt_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-chatbot-kit/src/assets/icons/user-alt.svg */ "./node_modules/react-chatbot-kit/src/assets/icons/user-alt.svg");
...
const BotAvatar = () => {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", {
    className: "react-chatbot-kit-bot-avatar",
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", {
      className: "react-chatbot-kit-user-avatar-container",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(react_chatbot_kit_src_assets_icons_user_alt_svg__WEBPACK_IMPORTED_MODULE_0__.ReactComponent, {
        className: "react-chatbot-kit-user-avatar-icon"
      })
    })
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BotAvatar);
...
/* harmony import */ var react_chatbot_kit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-chatbot-kit */ "./node_modules/react-chatbot-kit/build/index.js");
/* harmony import */ var react_chatbot_kit__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_chatbot_kit__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _BotAvatar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BotAvatar */ "./src/chatbot/BotAvatar.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__);
/**
 * External dependencies
...
const configFn = (instanceId, initialPrompt, selectedModel, chatbotName, ajaxUrl, nonce, initialState, isBlock, isShortcode, isElementor) => ({
  ...
  customComponents: {
    ...
    botAvatar: props => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_BotAvatar__WEBPACK_IMPORTED_MODULE_1__["default"], {
      ...props
    })
  },
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initializeChatEmbeds: () => (/* binding */ initializeChatEmbeds)
/* harmony export */ });
/* harmony import */ var react_chatbot_kit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-chatbot-kit */ "./node_modules/react-chatbot-kit/build/index.js");
/* harmony import */ var react_chatbot_kit__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_chatbot_kit__WEBPACK_IMPORTED_MODULE_0__);
 ...
 */
const initializeChatEmbeds = () => {
  const chatContainers = document.querySelectorAll('.simple-ai-chat-embed-instance' // Target all instances by the common class
  );
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunksimple_ai_chat_embed"] = globalThis["webpackChunksimple_ai_chat_embed"] || [];
